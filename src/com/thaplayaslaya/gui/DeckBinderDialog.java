...
public abstract class DeckBinderDialog extends JDialog {
	...
	private static final long serialVersionUID = -2086205915802067859L;
	...
	protected JList<Deck> jList1;
	protected JLabel jListLabel;
	...
	protected DeckBinder newDeckBinder;
	protected DeckBinderPanel deckBinderPanel1;
	protected JComboBox<Deck> newComboBox;
	protected DefaultComboBoxModel<Deck> listmodel1;

	protected FontEffectActionListener fontEffectActionListener;
	protected ListOrderActionListener listOrderActionListener;
	protected AppearanceActionListener appearanceActionListener;

	public DeckBinderDialog(Frame owner, String title, boolean modal) {
